...
describe('Student Registration page', () => {
  ...
  it('should allow to register a user', () => {
    ...
    cy.findByPlaceholder('Mobile Number').type(user.number);

    cy.get('#dateOfBirthInput').type('{selectall}6 Sep 1999{enter}');
    ...
    cy.contains('tr', 'Date of Birth').should('contain', '6 September,1999');
