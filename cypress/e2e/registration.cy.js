...
describe('Student Registration page', () => {
  ...
  it('should register a new student', () => {
    ...
    cy.get('#dateOfBirthInput').type('{selectall}01 Oct 2020{enter}');
    cy.get('.subjects-auto-complete__value-container').type('en{enter}' + 'phy{enter}');
    ...
    cy.contains('tr', 'Date of Birth').should('contain', '01 October,2020');
